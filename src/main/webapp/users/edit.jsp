      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <form action="${pageContext.request.contextPath}/user/edit" method="post">
            ...
            <label for="username"> Podaj nowe imie</label>
            <input type="text" class="form-control" id="exampleInputEmail1" name="username" value="${user.email}" />
            <label for="username"> Podaj nowego maila</label>
            <input type="text" class="form-control" id="exampleInputEmail1" name="email" value="${user.username}" />
            <label for="username"> Podaj nowe haslo</label>
